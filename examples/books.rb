 class BooksExample
    ...
    def initialize db, rebuild: true
      ...
      db.create_vertex_class :word
      ActiveOrient::Model::Word.create_property( :item , type: :string, index: :unique )
...
require '../config/boot'
    ...
    Word = r.open_class :word
    HC = r.open_class :has_content
    
    b.read_samples if Word.count.zero?
